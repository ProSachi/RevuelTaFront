...
export default function VentanaModalDetalleTrueque({ trueque, onClose, onActualizar }) {
  ...
  const [tipoContraoferta, setTipoContraoferta] = useState('intercambio_y_diferencia')
  const [prendaOfrecidaContraoferta, setPrendaOfrecidaContraoferta] = useState('Bolso de cuero')
  const [diferenciaContraoferta, setDiferenciaContraoferta] = useState(0)
  const [valorPagoContraoferta, setValorPagoContraoferta] = useState(0)
  ...
  useEffect(() => {
    ...
    setTipoContraoferta(trueque.tipo || 'intercambio_y_diferencia')
    setPrendaOfrecidaContraoferta(trueque.prendaOfrecida?.nombre || 'Bolso de cuero')
    setDiferenciaContraoferta(trueque.diferencia ?? 0)
    setValorPagoContraoferta(trueque.valorPropuesto ?? 0)
